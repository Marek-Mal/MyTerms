...
@Component({
  selector: 'app-posts-acc-sell',
  templateUrl: './posts-acc-sell.component.html',
  styleUrls: ['./posts-acc-sell.component.css']
})
export class PostsAccSellComponent implements OnInit {
